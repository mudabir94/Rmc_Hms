...
class User(AbstractUser):
    ...
    role = models.ForeignKey(
        Role, on_delete=models.CASCADE, default=None, null=True)
...
class Medicine(models.Model):
    medicine_type_id = models.ForeignKey(
        medicineType, on_delete=models.CASCADE, default=None, null=True)

    medicine_name = models.CharField(max_length=45)
    code_name = models.CharField(
        max_length=45, default=None, null=True, blank=True)
    weight = models.IntegerField(default=None, null=True, blank=True)
    litre = models.CharField(
        max_length=45, default=None, null=True, blank=True)

    medicine_details = models.CharField(max_length=45)
    add_charge = models.CharField(
        max_length=45, null=True, blank=True, default="No")
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    update_at = models.DateTimeField(auto_now_add=True, blank=True)
...
class medicineWarehouseStock(models.Model):
    medicine = models.ForeignKey(
        Medicine, on_delete=models.CASCADE, default=None, null=True)
    ...
    sell_piece_price_unit = models.FloatField(
...
class medicineWhStockHistory(models.Model):
    medicine_wh_stock = models.ForeignKey(
        medicineWarehouseStock, on_delete=models.CASCADE, default=None, null=True)
    purchase_rate = models.FloatField(default=0.00, null=True, blank=True)
    # quantity=models.IntegerField(default=10, null=True, blank=True)
    carton_unit = models.IntegerField(null=True, blank=True)
    box_unit = models.IntegerField(null=True, blank=True)
...
class medicineBatches(models.Model):
    ...
    medicine = models.ForeignKey(
        Medicine, on_delete=models.CASCADE, default=None, null=True)
    medicine_strg = models.ForeignKey(
        medicineWarehouseStock, on_delete=models.CASCADE, default=None, null=True)
    status = models.CharField(max_length=45, null=True, blank=True)
    barcode = models.CharField(
        max_length=55, null=True, blank=True, default="")
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    update_at = models.DateTimeField(auto_now_add=True, blank=True)
...
class tt_MedicineMedWhStock(models.Model):
    medicine = models.ForeignKey(
        Medicine, on_delete=models.CASCADE, default=None, null=True)
    mwhs = models.ForeignKey(medicineWarehouseStock,
...
class despensoryStockHistory(models.Model):
    desp_stock = models.ForeignKey(
        despensoryStock, on_delete=models.CASCADE, default=None, null=True)
    medicine_strg = models.ForeignKey(
        medicineWarehouseStock, on_delete=models.CASCADE, default=None, null=True)
    carton_unit = models.IntegerField(null=True, blank=True)
    box_unit = models.IntegerField(null=True, blank=True)
...
class despensoryMedincineBatch(models.Model):
    desp = models.ForeignKey(
        despensoryStock, on_delete=models.CASCADE, default=None, null=True)
    medwh_stock = models.ForeignKey(
        medicineWarehouseStock, on_delete=models.CASCADE, default=None, null=True)
    status = models.CharField(max_length=45, null=True, blank=True)
...
class tempDespensoryStock(models.Model):
    medicinewh_stock = models.ForeignKey(
        medicineWarehouseStock, on_delete=models.CASCADE, default=None, null=True)
    medicine = models.ForeignKey(
        Medicine, on_delete=models.CASCADE, default=None, null=True)
    carton_unit = models.IntegerField(null=True, blank=True)
...
class Employee(models.Model):
    ...
    employee_type = models.ForeignKey(
        employeeType, on_delete=models.CASCADE, default=None, null=True)
...
class patPrescriptionRecords(models.Model):
    ...
    patient = models.ForeignKey(
        Patient, on_delete=models.CASCADE, default=None, null=True, blank=True)
    patient_type = models.ForeignKey(
        patientType, on_delete=models.CASCADE, default=None, null=True, blank=True)
...
class tokenRecords(models.Model):
    patient = models.ForeignKey(
        Patient, default=None, null=True, blank=True, on_delete=models.DO_NOTHING)
    pres = models.ForeignKey(patPrescriptionRecords, default=None,
...
class patientBillRecords(models.Model):
    patient = models.ForeignKey(
        Patient, on_delete=models.CASCADE, default=None, null=True, blank=True)
    desp = models.ForeignKey(
        despensoryStock, on_delete=models.CASCADE, default=None, null=True, blank=True)
    pres = models.ForeignKey(patPrescriptionRecords, on_delete=models.CASCADE,
                             default=None, null=True, blank=True)  # NEW ######
    medicine = models.ForeignKey(
        Medicine, on_delete=models.CASCADE, default=None, null=True)
...
class patientMedRecords(models.Model):
    patient = models.ForeignKey(
        Patient, on_delete=models.CASCADE, default=None, null=True, blank=True)
    emp_doc = models.ForeignKey(
        Employee, on_delete=models.CASCADE, default=None, null=True, blank=True)
    pres = models.ForeignKey(patPrescriptionRecords, on_delete=models.CASCADE,
                             default=None, null=True, blank=True)  # NEW ######
    medicine = models.ForeignKey(
        Medicine, on_delete=models.CASCADE, default=None, null=True, blank=True)
    # blood_pressure=models.CharField(max_length=50,null=True,blank=True)
    prescription = ListCharField(base_field=models.CharField(
        max_length=20), size=10, max_length=(10*21), null=True, blank=True)
...
class patPrescriptionBill(models.Model):
    pres = models.ForeignKey(
        patPrescriptionRecords, on_delete=models.CASCADE, default=None, null=True, blank=True)
...
class surgeryTable(models.Model):  # NEW  ######
    ...
    operation_theater_fee = models.IntegerField(
        null=True, blank=True, default=500)
    anesthesiologist_fee = models.IntegerField(
        null=True, blank=True, default=500)
...
class surgeryBillRecord(models.Model):
    surgery = models.ForeignKey(
        surgeryTable, on_delete=models.CASCADE, default=None, null=True, blank=True)
    pres = models.ForeignKey(
        patPrescriptionRecords, on_delete=models.CASCADE, default=None, null=True, blank=True)
    surgeon_fee = models.IntegerField(null=True, blank=True, default=500)
    operation_theater_fee = models.IntegerField(
...
class surgeryRecords(models.Model):  # NEW  ######
    surgery_bill = models.ForeignKey(
        surgeryBillRecord, on_delete=models.CASCADE, default=None, null=True, blank=True)
    pres = models.ForeignKey(
        patPrescriptionRecords, on_delete=models.CASCADE, default=None, null=True, blank=True)
    consultant = models.ForeignKey(
        Employee, on_delete=models.CASCADE, default=None, null=True, blank=True)
    misc1 = models.CharField(max_length=50, null=True,
                             blank=True, default='NotPaid')
    misc2 = models.CharField(max_length=50, null=True,
                             blank=True, default='NotPaid')
    misc3 = models.CharField(max_length=50, null=True,
                             blank=True, default='NotPaid')
    misc4 = models.CharField(max_length=50, null=True,
                             blank=True, default='NotPaid')
    misc5 = models.CharField(max_length=50, null=True,
                             blank=True, default='NotPaid')
...
class procedureBillRecord(models.Model):  # NEW  ######
    procedure = models.ForeignKey(
        procedureTable, on_delete=models.CASCADE, default=None, null=True, blank=True)
    pres = models.ForeignKey(
        patPrescriptionRecords, on_delete=models.CASCADE, default=None, null=True, blank=True)
    net_total = models.IntegerField(null=True, blank=True, default=0)
    status = models.CharField(max_length=50, null=True,
...
class procedureRecords(models.Model):  # NEW  ######
    procedure_bill = ListCharField(base_field=models.CharField(
        max_length=20), size=10, max_length=(10*21), null=True, blank=True)
    pres = models.ForeignKey(
        patPrescriptionRecords, on_delete=models.CASCADE, default=None, null=True, blank=True)
    net_total = models.IntegerField(null=True, blank=True, default=0)
...
class patientRoomsBill(models.Model):
    ...
    rooms = models.ForeignKey(
        Rooms, on_delete=models.CASCADE, default=None, null=True, blank=True)
...
class patientWardBill(models.Model):
    ...
    pres = models.ForeignKey(patPrescriptionRecords, on_delete=models.CASCADE,
                             default=None, null=True, blank=True)  # NEW ##########
    wards = models.ForeignKey(Ward, on_delete=models.CASCADE,
                              default=None, null=True, blank=True)  # NEW ##########
...
class patientVisitSummary(models.Model):
    pmr = models.ForeignKey(
        patientMedRecords, on_delete=models.CASCADE, default=None, null=True, blank=True)
    pres = models.ForeignKey(patPrescriptionRecords, on_delete=models.CASCADE,
                             default=None, null=True, blank=True)  # NEW ##########
    patient = models.ForeignKey(
        Patient, on_delete=models.CASCADE, default=None, null=True, blank=True)
...
class surgeryBillSummary(models.Model):
    sbr = ListCharField(base_field=models.CharField(
        max_length=20), size=10, max_length=(10*21), null=True, blank=True)
    pres = models.ForeignKey(
        patPrescriptionRecords, on_delete=models.CASCADE, default=None, null=True, blank=True)
    net_total = models.IntegerField(null=True, blank=True, default=0)
...
class procedureBillSummary(models.Model):
    procbr = ListCharField(base_field=models.CharField(
        max_length=20), size=10, max_length=(10*21), null=True, blank=True)
    pres = models.ForeignKey(
        patPrescriptionRecords, on_delete=models.CASCADE, default=None, null=True, blank=True)
    net_total = models.IntegerField(null=True, blank=True, default=0)
...
class invoiceRecords(models.Model):
    pres = models.ForeignKey(
        patPrescriptionRecords, on_delete=models.CASCADE, default=None, null=True, blank=True)
    desp_bill = models.ForeignKey(
        despBillRecord, on_delete=models.CASCADE, default=None, null=True, blank=True)
    surgery_bill = models.ForeignKey(
        surgeryBillSummary, on_delete=models.CASCADE, default=None, null=True, blank=True)
    ward_bill = models.ForeignKey(
        patientWardBill, on_delete=models.CASCADE, default=None, null=True, blank=True)
    procedure_id = models.ForeignKey(
        procedureBillSummary, on_delete=models.CASCADE, default=None, null=True, blank=True)
    room_bill = models.ForeignKey(
        patientRoomsBill, on_delete=models.CASCADE, default=None, null=True, blank=True)
    discount = models.IntegerField(null=True, blank=True)
    discount_percentage = models.FloatField(null=True, blank=True)
    net_total = models.IntegerField(null=True, blank=True, default=0)
